...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Location currantLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //При нажатие будем отображать ближайшие машины такси
    ...
    private void gettingNearestTaxi() {
        ...
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(currantLocation.getLatitude(),
                currantLocation.getLongitude()), searchRadius);
        ...
        nearestDriverLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    float distanceToDriver = driverLocation.distanceTo(currantLocation);

                    bookTaxiButton.setText("DistanceToDriver: " + distanceToDriver);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (currantLocation != null) {
            // Add a marker in Sydney and move the camera
            LatLng driverLocation = new LatLng(currantLocation.getLatitude(),
                    currantLocation.getLongitude());
    ...
    private void buildLocationCallback() {
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                currantLocation = locationResult.getLastLocation();
    ...
    private void updateLocationUi() {
        if (currantLocation != null) {
            LatLng passengerLocation = new LatLng(currantLocation.getLatitude(),
                    currantLocation.getLongitude());
            ...
            geoFire.setLocation(passengerUserId, new GeoLocation(currantLocation.getLatitude(),
                    currantLocation.getLongitude()));
        }
    }
    ...
    private void requestLocationPermission() {
        boolean shoulgProvideRationale = ActivityCompat.shouldShowRequestPermissionRationale(this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        if (shoulgProvideRationale) {
